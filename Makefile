...
define  Package/lirc/install
	...
	$(INSTALL_DIR) $(1)/etc
	$(INSTALL_CONF) ./files/lircd.conf $(1)/etc/ #mod
endef
#todo:
...
define  Package/lirctools/install
	...
	$(INSTALL_BIN) $(PKG_BUILD_DIR)/tools/.libs/lircrcd $(1)/usr/sbin/
	$(INSTALL_DIR) $(1)/usr/lib/
	$(INSTALL_BIN) $(PKG_BUILD_DIR)/tools/.libs/liblirc_client.so $(1)/usr/lib/
	$(INSTALL_BIN) $(PKG_BUILD_DIR)/tools/.libs/liblirc_client.so.0 $(1)/usr/lib/
	$(INSTALL_BIN) $(PKG_BUILD_DIR)/tools/.libs/liblirc_client.so.0.2.1 $(1)/usr/lib/
	$(INSTALL_BIN) $(PKG_BUILD_DIR)/tools/.libs/lirc_client.o $(1)/usr/lib/
	$(INSTALL_DIR) $(1)/etc/wifiradio
	$(INSTALL_CONF) ./files/lircrc $(1)/etc/wifiradio/ #mod
endef
